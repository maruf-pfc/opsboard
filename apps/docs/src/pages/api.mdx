---
title: Backend API
description: This directory contains the Node.js/Express backend API for the OpsBoard application. It provides a secure, versioned REST API for all data and business logic.
---
