...
exports.getPayments = asyncHandler(async (req, res) => {
    const payments = await Payment.find().populate('trainer', 'name email').sort({ createdAt: -1 });
...
exports.updatePayment = asyncHandler(async (req, res) => {
    ...
    payment = await Payment.findByIdAndUpdate(req.params.id, req.body, { new: true, runValidators: true });
